...
import { m1options } from '../constants'
...
const OptionsM1 = () => {
  ...
  return (
    <section className="mt-[4em] mb-12 bg-mainBlue">
        ...
        <div className="banner-image h-[300px] md:h-[400px] xl:h-[500px]" style={{ backgroundImage: `url(https://www.masqueunefecto.com/wp-content/uploads/2024/02/banner-mach-1.jpg)`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        </div>
            {m1options.map((section) => (
