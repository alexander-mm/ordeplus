...
const Machines = () => {
    return (
        <section className="mt-[4em] md:mt-[5em] bg-mainBlue">
            <h1 className="text-white text-center font-avenir text-[35px] lg:text-[40px] pt-1">EQUIPOS DE ORDEÑO</h1>
            <div className='border-white border-t-[0.1px] border-opacity-40 mx-auto lg:max-w-screen-lg mb-4'></div>
            <div className="banner-image h-[300px] md:h-[400px] xl:h-[500px]" style={{ backgroundImage: `url(${banner})`, backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
            <h1 className="text-white text-center font-avenir text-[30px] mt-3">EQUIPOS PORTÁTILES</h1>
            <div className='border-white border-t-[0.1px] border-opacity-40 mx-auto lg:max-w-screen-lg'></div>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-xl:grid-cols-1 py-4 mx-auto lg:max-w-screen-2xl">
                    ...
                    <div key={item.key} className="col-span-1 lg:col-span-2 mb-4">
                        <div className="flex justify-center items-center flex-col text-center font-avenir text-white shadow-lg">
                            <div className='w-full flex flex-row justify-around items-center'>
                                <img className='max-md:w-40 w-64m-2' src={item.src} alt="" />
                                <div className='text-xl'>
                                    <p className='mx-2'>{item.desc1}</p>
                                    <p className='mx-2'>{item.desc2}</p>
                                    <p className='font-extrabold mx-2'>{item.desc3}</p>
                                </div>
                            </div>
            ...
            <h1 className="text-white text-center font-avenir text-[30px] mt-10">EQUIPOS TIPO SALA</h1>
            <div className='border-white border-t-[0.1px] border-opacity-40 mx-auto lg:max-w-screen-lg mb-4'></div>
            <div className="grid grid-cols-1 gap-6 mx-auto lg:max-w-screen-2xl">
                {roomMachines.map((item) => (
                    <div key={item.key} className="col-span-1 lg:col-span-2 mb-4">
                        <div className="flex justify-center items-center flex-col text-center font-avenir text-white">
