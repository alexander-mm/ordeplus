...
const Engines = () => {
    return (
        <section className="mt-[5em] bg-mainBlue">
            <h1 className="text-white text-center font-avenir text-[40px] pt-1">MOTORES</h1>
            ...
            <div className="banner-image h-[300px] md:h-[400px] xl:h-[500px]"
                style={{ backgroundImage: `url(${banner3})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
            ></div>
            {engines.map((section) => (
